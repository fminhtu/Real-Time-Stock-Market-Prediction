...
def graphData(stock,MA1,MA2,interval):
	...
	if count == -1:
		...
		manual_run = False
		main(temp, 10, "model_noisynstepperdddqn_30", True, manual_run)
	...
	print("ax1.xais: ", ax1.get_xticklabels())
	...
	plt.ylabel('MACD')
	ax2.yaxis.set_major_locator(mticker.MaxNLocator(nbins=5, prune='upper')) ## set datetime x
